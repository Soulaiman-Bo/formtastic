...
const LeftSideBar = () => {
  return (
    <div className=" w-full pt-4  overflow-auto bg-gray-50 flex flex-col justify-between border-r-[0.5px] border-l-[0.5px] border-gray-300 h-full max-w-[226px] min-w-[180px] lg:max-w-[300px] lg:min-w-[270px] ">
