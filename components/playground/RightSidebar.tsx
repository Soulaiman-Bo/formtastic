...
const RightSidebar = () => {
  return (
    <div className="w-full bg-gray-50  flex-col justify-between border-r-[0.5px] border-l-[0.5px] border-gray-300 h-full overflow-y-auto pb-6 max-w-[300px] min-w-[270px] relative">
        ...
        <div className="flex justify-center flex-col w-full">
          ...
          <div className="text-slate-200 flex items-center font-medium justify-between pr-2">
            ...
            <div className="inline-block z-[14]">
              <Button onClick={()=>{}} variant="link" className="cursor-pointer p-4" data-cy="widget-back-button">
                <svg
